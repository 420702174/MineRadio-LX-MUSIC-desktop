...
var userPlaylists = [], neteasePlaylists = [], qqPlaylists = [], kugouPlaylists = [], qishuiPlaylists = [], spotifyPlaylists = [], localPlaylistSongs = [], myPodcastCollections = [], myPodcastItems = {}, playlistCoverCache = {};
...
var PLAYBACK_QUALITY_DEFAULTS = { netease: 'hires', qq: 'lossless', kugou: 'lossless', qishui: 'standard', spotify: 'standard', lx: 'hires' };
var PLAYBACK_QUALITY_OPTIONS = {
  ...
  lx: [
    { key: 'hires', title: '导入源高音质', sub: '优先向 LX 音源请求高规格' },
    { key: 'lossless', title: '导入源无损', sub: '兼顾音质与兼容性' },
    { key: 'exhigh', title: '导入源高品质', sub: '320k / 通用质量' },
    { key: 'standard', title: '导入源标准', sub: '128k / 兼容优先' }
  ]
};
