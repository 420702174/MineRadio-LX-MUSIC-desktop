...
function renderHomeDashboardQuickCards() {
  ...
  var localPlaylistCount = Array.isArray(localPlaylistSongs) ? localPlaylistSongs.length : 0;
  ...
  var cards = [
    ...
    },
    {
      label: 'LOCAL LIST',
      title: '本地歌单',
      sub: localPlaylistCount ? (localPlaylistCount + ' 首 · 管理无需登录的收藏') : '管理无需登录的本地收藏',
      cover: localPlaylistSongs && localPlaylistSongs[0] ? homeDashboardSongCover(localPlaylistSongs[0], 260) : '',
      action: 'openHomeLocalPlaylistManager()',
      tone: 'local',
      className: 'home-card-quick',
    },
  ];
